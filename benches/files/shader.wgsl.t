...
Directive("if", Some("LINEAR_SPACE"))
...
Directive("if", Some("TRANSFORM // comment after the end if expression"))
...
Directive("endif", Some("// comment after the endif directive"))
Code("")
Code("            switch (p_index) {")
...
Directive("endif", None)
Code("        }")
Directive("if", Some("EXTRA_PRIMITIVES"))
...
Directive("endif", None)
Code("        }")
Directive("endif", Some("// EXTRA_PRIMITIVES"))
Code("        default: {")
Code("            pos_ss = vec2<f32>(0.0, 0.0);")
Code("        }")
Code("    }")
